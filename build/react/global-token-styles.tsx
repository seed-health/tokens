...
:root {
  ...
  --guidance-guidance-primary: var(--color-guidance-bright-green);
  ...
  --radius-large: var(--size-800);
  --radius-medium: var(--size-400);
  --radius-small: var(--size-200);
  --radius-x-small: var(--size-100);
